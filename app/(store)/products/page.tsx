      ...
      <Container>
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Explore our complete collection of handcrafted, premium sarees designed for every occasion.
          </p>
        </div>
        ...
        <div className="flex items-center text-sm text-muted-foreground mb-8 overflow-x-auto pb-2 whitespace-nowrap">
          ...
          <span className="text-charcoal font-medium">All Sarees</span>
        </div>
          ...
          <div className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-24 bg-white p-6 border border-border-light rounded-lg">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-medium text-charcoal mb-3">Fabric</h3>
                  <div className="space-y-2">
                    {['Pure Silk', 'Cotton', 'Banarasi', 'Kanjivaram', 'Linen', 'Organza'].map((fabric) => (
                      <label key={fabric} className="flex items-center gap-3 cursor-pointer group">
                        <div className="w-5 h-5 rounded border border-border-light flex items-center justify-center group-hover:border-gold transition-colors"></div>
                        <span className="text-sm text-muted-foreground group-hover:text-charcoal transition-colors">{fabric}</span>
                      </label>
                    ))}
                  </div>
                </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
              <p className="text-muted-foreground text-sm">
                Showing <span className="font-medium text-charcoal">{products.length}</span> products
              </p>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-20 bg-white border border-border-light border-dashed rounded-lg">
                ...
                <p className="text-muted-foreground">We couldn't find any products.</p>
              </div>
            )}
          </div>
        </div>
